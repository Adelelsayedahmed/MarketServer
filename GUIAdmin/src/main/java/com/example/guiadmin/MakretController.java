...
public class MakretController implements Initializable {
    ...
    public void UpdatePrice(ActionEvent event) throws IOException {
        ...
        else RegisterAdminController.Alert("price field can't be empty");
        newP.clear();
    ...
    public void UpdateQuantity(ActionEvent event) throws IOException {
        try{
            ...
            else RegisterAdminController.Alert("Quantity field can't be empty");
            newQ.clear();}
        catch (Exception e){
            RegisterAdminController.Alert("Select a valid row");
        }
    }
